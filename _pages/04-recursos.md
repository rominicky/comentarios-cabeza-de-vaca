...
<div class="container mx-auto px-2">
  <div class="py-1 mb-0 prose">
   <h2 class="izquierda">
      ...
      </svg> <a class="no-underline" title="Análisis textual estadístico" href="notebook" target="_blank">Notebook</a>
  </h2>
  <a class="h3 lh-condensed" href="notebook" target="_blank"><p>Exploración y análisis cuantitativo de la obra de Álvar Núñez Cabeza de Vaca</p></a></div>
